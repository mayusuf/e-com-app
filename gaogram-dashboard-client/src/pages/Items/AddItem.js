...
export default function AddItem() {
    ...
    const onSubmit = data => {
        ...
        // const newItem = { item_name: itemName, item_img: image, item_desc: itemDescription, item_price: price, cat_id: categoryId, create_date: date_time, in_stock: inStock, is_active: isActive };
        ...
        formData.append('create_date',date_time)
        formData.append('in_stock',inStock)
        formData.append('is_active',isActive)

        if (formData) {
            handleAddition(formData)
        }
    };


    const handleAddition = (newItem) => {
        const url = `http://localhost:3100/item/add`;
                                    ...
                                    <Container component="main" maxWidth="sm" sx={{ mb: 4 }}>
                                        <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
                                            ...
                                            <React.Fragment>
                                                ...
                                                >
                                                    <DialogTitle>{"Do you Want to ADD this Item?"}</DialogTitle>
                                                    <DialogActions>
